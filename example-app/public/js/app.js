...
__webpack_require__(/*! ./custom_student */ "./resources/js/custom_student.js");
  ...
  $("#rollDice").on("click", function () {
    $.ajax({
      ...
      success: function success(jsonObj) {
        ...
        $("#" +
        /*get P1 position*/
        +"P1").removeClass("triangleP1");
        $("#" +
        /*get P1 position*/
        +"P1").addClass("triangleP1");
        $("#" +
        /*get P2 position*/
        +"P2").removeClass("triangleP2");
        $("#" +
        /*get P2 position*/
        +"P2").addClass("triangleP2");
      }
    });
  });
...
/***/ "./resources/js/custom_student.js":
/*!****************************************!*\
  !*** ./resources/js/custom_student.js ***!
  \****************************************/
/***/ (() => {
